...
export const DEFAULT_ROUTING_RULES: RoutingRules = {
  ...
  avg_speed_mph: 28,
  speed_bands_enabled: true,
  speed_band_short_miles: 5,
  speed_band_long_miles: 15,
  avg_speed_short_mph: 20,
  avg_speed_mid_mph: 30,
  avg_speed_long_mph: 42,
...
const NUMBER_KEYS: (keyof RoutingRules)[] = [
  ...
  "day_length_hours",
  "avg_speed_mph",
  "speed_band_short_miles",
  "speed_band_long_miles",
  "avg_speed_short_mph",
  "avg_speed_mid_mph",
  "avg_speed_long_mph",
